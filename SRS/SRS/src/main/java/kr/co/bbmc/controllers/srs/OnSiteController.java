 ...
 * 현장날씨 컨트롤러
 */
@Controller("srs-on-site-controller")
@RequestMapping(value = "/srs/onsite")
public class OnSiteController {

	private static final Logger logger = LoggerFactory.getLogger(OnSiteController.class);
	...
	public String index(Model model, Locale locale, HttpSession session, HttpServletRequest request) {
		...
		msgMgr.addViewMessages(model, locale, new Message[] { new Message("pageTitle", "현장정보"), });
