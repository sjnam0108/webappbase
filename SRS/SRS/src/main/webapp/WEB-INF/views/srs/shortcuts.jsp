...
<h4 class="pt-1 pb-3 mb-3">
	<i class="mr-1 fa fa-home"></i> ${pageTitle}
</h4>
				...
				<div class="card-body">
					...
					<div class="float-right">
						<button id="move-btn" type="button"
							...
							onclick="moveUrl('recontrolauto')">이동</button>
					</div>
				</div>
			</div>
			<div class='card col-md-4 col-sm-4 col-4 col-lg-4 col-xl-4'>
				<div class="card-body">
					...
					<div class="float-right">
						<button id="move-btn" type="button"
							class="btn btn-outline-success"
							onclick="moveUrl('recontrolpassive')">이동</button>
					</div>
				</div>
			</div>
						<div class='card col-md-4 col-sm-4 col-4 col-lg-4 col-xl-4'>
				<div class="card-body">
					...
					<div class="float-right">
						<button id="move-btn" type="button"
							class="btn btn-outline-success"
							onclick="moveUrl('noticesetting')">이동</button>
					</div>
				</div>
			</div>
		</div>
